...
```{r get those ids}
OAuth_Token = "BQASx6SJs6LqApa-o4hnSpPz48m1ZKv5UGaV8-KwxZxSjgcJ3qXmd17kIDEXY8FS2b36O82EElnKSUM3x5uam-iydPh8lxYYAHbxWtTl-qKja3K1Xg6Yv8XjyHdWY0OwM4sva2cCSVTMd1bIAv9UxOvm47liaQ"
...
listening_trends = song_final %>%
  filter(is.na(quarters) == F  & (monthyear != "Nov 2019" | monthyear != "Dec 2019"))
...
listening_by_cluster = listening_by_cluster %>%
  gather(.,cluster,streams,2:9,factor_key = T) %>%
...
write.csv(artist_monthly,"Output_Files/artist_listening_trends.csv")
write.csv(track_monthly,"Output_Files/track_listening_trends.csv")
